...
class TenImageTasksCifar(Tasks):
    # Split the dataset into 100/10 = 10 sub-datasets. Each sub-dataset contains images of a five classes
    def split_dataset(self, dataset):
        datasets = []
        self.names = []
...
class TwentyImageTasksCifar(Tasks):
    # Split the dataset into 100/20 = 5 sub-datasets. Each sub-dataset contains images of a five classes
    def split_dataset(self, dataset):
        datasets = []
        self.names = []
...
class FiftyImageTasksCifar(Tasks):
    # Split the dataset into 100/50 = 2 sub-datasets. Each sub-dataset contains images of a five classes
    def split_dataset(self, dataset):
        datasets = []
        self.names = []
