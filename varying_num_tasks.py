...
def main():
    ...
    parser.add_argument("--run_num", type=str, default='', help="The run number. Just for wandb \"sweep\" purposes")
    parser.add_argument("--num_tasks", type=int, help="The number of tasks to train on (each task gets total_classes / num_tasks classes)")
    parser.add_argument("--batch_size", type=int, default=256, help="Batch size for training")
    parser.add_argument("--epochs_train", type=int, default=75, help="Number of training epochs")
    parser.add_argument("--epochs_retrain", type=int, default=75, help="Number of epochs when retraining probed layers")
    ...
    cl_training = CLTraining(
        ...
        tasks=task.get_tasks_zipped(batch_size=batch_size)[:num_tasks],
